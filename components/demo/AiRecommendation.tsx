  ...
  return (
    ...
    >
      ...
      <div className="px-5 pt-5 pb-4 border-b border-white/[0.05]">
        ...
        <div className="flex items-start justify-between gap-3">
          ...
          <div className="flex-shrink-0 flex flex-col items-center gap-0.5">
            <svg width="48" height="48" viewBox="0 0 48 48" aria-label={`Confidence: ${confidence}%`}>
      ...
      <div className="px-5 py-4 border-b border-white/[0.05]">
        <p className="text-[10px] font-mono text-white/35 uppercase tracking-widest mb-2.5">Why This Station</p>
            ...
            <li key={i} className="flex items-start gap-2.5">
              <span className="mt-0.5 flex-shrink-0 w-4 h-4 rounded-full bg-[#FF7A00]/15 border border-[#FF7A00]/30 flex items-center justify-center">
                <svg width="7" height="6" viewBox="0 0 7 6" fill="none">
                  <path d="M1 3L2.8 5L6 1" stroke="#FF7A00" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              </span>
      ...
      <div className="px-5 py-4 grid grid-cols-3 gap-3 border-b border-white/[0.05]">
        ...
        <div>
          <p className="text-[10px] font-mono text-white/35 uppercase tracking-wider mb-1">Time Saved</p>
      ...
      {rejectedStations.length > 0 && (
        <div className="px-5 py-4">
          <p className="text-[10px] font-mono text-white/25 uppercase tracking-widest mb-2">Alternatives Rejected</p>
              ...
              <div key={st.id} className="flex items-center gap-2.5">
                <span className="flex-shrink-0 w-4 h-4 rounded-full bg-white/[0.05] border border-white/10 flex items-center justify-center">
                  <svg width="6" height="6" viewBox="0 0 6 6" fill="none">
                    <path d="M1 1L5 5M5 1L1 5" stroke="rgba(255,255,255,0.3)" strokeWidth="1.2" strokeLinecap="round" />
                  </svg>
                </span>
