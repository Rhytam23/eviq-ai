...
- **Explainability Registry**: Every recommendation generated by the Decision Engine is saved alongside its confidence intervals and weight parameters to explain to the driver *why* a charger was recommended (e.g., "Recommended Electrify America Stop 2: 98% reliability, saves 14 mins over closer stations").
